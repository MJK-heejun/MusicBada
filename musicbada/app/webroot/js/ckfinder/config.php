...
function CheckAuthentication()
{
    ...
    if( isset($_SESSION['Auth']['User']) ){ 
		if($_SESSION['Auth']['User']['role'] == 'admin' || $_SESSION['Auth']['User']['role'] == 'normal'){
    		return true; 
		}else{
		    return false;
		}
...
$config['LicenseName'] = '';
$config['LicenseKey'] = 'RWXC-9199-H9HR-219H-SRS3-X124-KBTV';
...
$baseUrl = '/../musicbada_upload/'.$_SESSION['Auth']['User']['username'].'/';
//$baseUrl = '/main/app/webroot/upload/'.$_SESSION['Auth']['User']['username'].'/';
...
$config['ResourceType'][] = Array(
		'name' => 'My Music',				// Single quotes not allowed
		'url' => $baseUrl . 'music',
		'directory' => $baseDir . 'music',
		'maxSize' => '100M',
		'allowedExtensions' => 'aiff,flac,mp3,mpc,wav,wma',
		'deniedExtensions' => '');
...
$config['FilesystemEncoding'] = 'EUC-KR';
