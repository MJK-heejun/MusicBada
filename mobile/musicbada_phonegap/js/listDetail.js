listDetailPlayUrl = myBaseUrl+"/main/WebServices/mPlay/"+username+"/"+uuid+"/"+token+"?path=";
...
function musicListRetrieve(){
	...
	var myUrl = myBaseUrl+"/main/WebServices/mJsonList/"+username+"/"+uuid+"/"+token+"/Play All";
